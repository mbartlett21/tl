-- module teal.api.v1 from teal/api/v1.lua
package.preload["teal.api.v1"] = function(...)
...
-- module teal.check.type_checker from teal/check/type_checker.lua
package.preload["teal.check.type_checker"] = function(...)
