...
do
   ...
   local record StandardLibrary
      ...
      load: function(chunk: (string | LoadFunction), chunkname?: string, mode?: LoadMode, env?: {any:any}): (function, string)
      load: function(chunk: (string | LoadFunction), chunkname?: string, mode?: string,   env?: {any:any}): (function, string)

      loadfile: function(filename?: string, mode?: LoadMode, env?: {any:any}): (function, string)
      loadfile: function(filename?: string, mode?: string,   env?: {any:any}): (function, string)
